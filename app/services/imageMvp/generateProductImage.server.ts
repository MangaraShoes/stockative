...
- If seated, both feet must be in a physically natural resting position — either both flat/grounded, or one leg simply crossed over the other at the knee with both feet settled. Never one foot lifted or hanging unsupported in mid-air: nobody sits still with a foot floating like that, and it reads as broken anatomy, not a candid pose.
